...
def registerPost():
    ...
    if client_id:
        ...
        if response.status_code == 200:
           webhook_url = f"https://api.telegram.org/bot{bot_id}/setWebhook?url=https://particle-server-73a84.ondigitalocean.app/{bot_id}/{response_data.get('access_token')}/{eventname}/{team_name}"
